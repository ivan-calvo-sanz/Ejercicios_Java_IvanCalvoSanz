...
// https://www.youtube.com/watch?v=cBPl4YV0k84&list=PLaxZkGlLWHGX4hJql-ZDN1vi76slkLepT&index=3
/*
Queremos representar con programación orientada a objetos, un CLASE AULA con CLASE ESTUDIANTE y un CLASE PROFESOR.
...
El aula debe tener un identificador numérico, el número máximo de estudiantes y  para que esta destinada (matemáticas, filosofía o física). 
Piensa que más atributos necesita.
...
en el aula correspondiente (un profesor de filosofía no puede dar en un aula de matemáticas) y que haya más del 50% de alumnos.
